...
public class AdministratorsImpl implements AdministratorsService {
    ...
    @Override
    public int count(String username) {return administratorsDao.count(username);
    }

    @Override
    public boolean save(Administrators administrators) {
        administrators.setCtime((new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
                .format(new Date())));
    ...
    public boolean update(Administrators administrators) {
        administrators.setMtime(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss")
                .format(new Date()));
